...
class YamlFileLoaderTest extends TestCase
{
    ...
    public function testImportingWithControllerDefault()
    {
        ...
        $this->assertCount(3, $routes);
        $this->assertEquals('AlumnosController::defaultAction', $routes->get('home.en')->getDefault('_controller'));
        $this->assertEquals('AlumnosController::defaultAction', $routes->get('home.nl')->getDefault('_controller'));
        $this->assertEquals('AlumnosController::defaultAction', $routes->get('not_localized')->getDefault('_controller'));
    }
