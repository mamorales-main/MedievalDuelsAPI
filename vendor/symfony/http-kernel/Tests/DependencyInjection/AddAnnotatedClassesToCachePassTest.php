...
class AddAnnotatedClassesToCachePassTest extends TestCase
{
    public function testExpandClasses()
    {
        ...
        $this->assertSame(
            'Acme\\FooBundle\\Controller\\AlumnosController',
            $expand(['**Bundle\\Controller\\'], ['\\Acme\\FooBundle\\Controller\\AlumnosController'])[0]
        );

        $this->assertSame(
            'FooBundle\\Controller\\AlumnosController',
            $expand(['**Bundle\\Controller\\'], ['\\FooBundle\\Controller\\AlumnosController'])[0]
        );

        $this->assertSame(
            'Acme\\FooBundle\\Controller\\Bar\\AlumnosController',
            $expand(['**Bundle\\Controller\\'], ['\\Acme\\FooBundle\\Controller\\Bar\\AlumnosController'])[0]
        );

        $this->assertSame(
            'Bundle\\Controller\\Bar\\AlumnosController',
            $expand(['**Bundle\\Controller\\'], ['\\Bundle\\Controller\\Bar\\AlumnosController'])[0]
        );

        $this->assertSame(
            'Acme\\Bundle\\Controller\\Bar\\AlumnosController',
            $expand(['**Bundle\\Controller\\'], ['\\Acme\\Bundle\\Controller\\Bar\\AlumnosController'])[0]
        );
