...
// Returns the private 'App\Repository\EquipoPlantillasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EquipoPlantillasRepository.php';

return $this->privates['App\\Repository\\EquipoPlantillasRepository'] = new \App\Repository\EquipoPlantillasRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
