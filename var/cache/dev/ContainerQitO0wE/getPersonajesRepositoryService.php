...
// Returns the private 'App\Repository\PersonajesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PersonajesRepository.php';

return $this->privates['App\\Repository\\PersonajesRepository'] = new \App\Repository\PersonajesRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
