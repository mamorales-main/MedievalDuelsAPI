...
// Returns the private 'App\Repository\UsuariosDetallesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UsuariosDetallesRepository.php';

return $this->privates['App\\Repository\\UsuariosDetallesRepository'] = new \App\Repository\UsuariosDetallesRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
