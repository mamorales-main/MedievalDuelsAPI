...
// Returns the private 'App\Repository\PersonajesDetallesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PersonajesDetallesRepository.php';

return $this->privates['App\\Repository\\PersonajesDetallesRepository'] = new \App\Repository\PersonajesDetallesRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
